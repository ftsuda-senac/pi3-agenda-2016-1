 ...
 */
package br.senac.tads.pi3.ftsuda82.agendaweb.filter;


import br.senac.tads.pi3.ftsuda82.agendaweb.entity.UsuarioSistema;
...
public class AutorizacaoFilter implements Filter {
  ...
  private static boolean verificarAcesso(UsuarioSistema usuario, HttpServletRequest req, HttpServletResponse resp) {
    ...
    if (pagina.endsWith("AgendaServlet") && usuario.autorizado("BASICO")) {
      return true;
